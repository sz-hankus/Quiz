        ...
        private void SaveQuiz(object ignorethis)
        {
            ...
            try
            {
                if (passwordInputVM.Password == "")
                    ...
                    Model.DataBaseManager.SaveQuizToEncryptedDB(Quiz, saveFileDialog.FileName, passwordInputVM.Password);    
            }
            catch (System.Exception ex)
            {
                Debug.WriteLine(ex);
                MessageBox.Show($"Unable to save the quiz to {saveFileDialog.FileName}", "Saving error", MessageBoxButton.OK, MessageBoxImage.Error);
            }
        }
        ...
        private void LoadQuiz(object ignorethis)
        {
            ...
            try
            {
                if (passwordInputVM.Password == "")
                    ...
                    Quiz = Model.DataBaseManager.ReadQuizFromEncryptedDB(openFileDialog.FileName, passwordInputVM.Password);
            }
            catch (System.Exception ex)
            {
                Debug.WriteLine(ex);
